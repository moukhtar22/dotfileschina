...
# ================================
# Combined Installation Script for DotfilesChina + Packages (AMD CPU/GPU)
...
PACMAN_PACKAGES=(
    ...
    firefox-tridactyl-native amd-ucode vulkan-radeon libva-mesa-driver mesa-vdpau lib3dxf clinfo btop htop-vim iotop-c
    fastfetch duf progress s-tui perl-image-exiftool zsh yt-dlp starship reflector quarto-cli-bin pandoc-bin less gum graphviz
    gocryptfs eza git git-crypt git-delta topgrade ttyper rsync rm-improved glow prettyping bob cht.sh-git bat yazi ffmpeg
    ffmpegthumbnailer p7zip jq poppler fd ripgrep ripgrep-all fzf zoxide imagemagick mmv-c-git ripdrag rclone bc carapace-bin
    impala bluetui fcitx5 fcitx5-chinese-addons fcitx5-material-color ttf-noto-cjk ttf-wqy-microhei ttf-wqy-zenhei i3-gaps
    polybar rofi alacritty neovim pamixer scrot maim xclip feh dunst playerctl
)
